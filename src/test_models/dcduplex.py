...
class DCDuplex(GConvNet):
    def __init__(self,img_shape=(28,28,1),y_dim=35,z_dim=35,num_classes=10,recon=1,xent=1,kernel_regularization=None):
...
#         q_net = Dense(128, activation='linear')(y_lat)
        label = Dense(self.num_classes, activation='softmax',name='label')(y_lat)
